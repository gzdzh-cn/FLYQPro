...
func ensureSchemaColumns(ctx context.Context, database gdb.DB) error {
	migrations := []struct{ table, column, definition string }{
		...
		{"peers", "link_type", "TEXT NOT NULL DEFAULT 'unknown'"},
		{"peers", "link_speed_mbps", "INTEGER NOT NULL DEFAULT 0"},
		{"peers", "interface_name", "TEXT NOT NULL DEFAULT ''"},
		{"peers", "local_addresses", "TEXT NOT NULL DEFAULT ''"},
		...
		{"messages", "deleted_at", "TEXT NOT NULL DEFAULT ''"},
		{"messages", "quote_message_id", "TEXT NOT NULL DEFAULT ''"},
		{"messages", "quote_content", "TEXT NOT NULL DEFAULT ''"},
		{"messages", "forwarded_from", "TEXT NOT NULL DEFAULT ''"},
