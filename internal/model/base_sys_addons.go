...
type BaseSysAddons struct {
	*dzhcore.Model
	...
	AddonsName string  `gorm:"column:addonsName;type:varchar(100);not null;default:'';index;comment:插件英文名称" json:"addonsName"`
	IsCustom   int     `gorm:"column:isCustom;type:tinyint;not null;default:0;comment:是否自定义添加" json:"isCustom"`
