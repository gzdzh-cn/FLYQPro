...
type MemberUpdateReq struct {
	g.Meta   `path:"/memberUpdate" method:"POST"`
	Name     string `json:"name" p:"name" dc:"姓名"`
	NickName string `json:"nickName" p:"nickName" dc:"昵称"`
	Password string `json:"password" p:"password" dc:"密码"`
}
