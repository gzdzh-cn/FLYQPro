...
// TaskInfo mapped from table <addons_task_info>
type TaskInfo struct {
	*dzhcore.Model
	...
	AddonsName  string     `json:"addonsName" gorm:"column:addonsName;type:varchar(100);not null;default:task;index;comment:所属插件"`
