...
.shared-drive { width:100%; height:100%; overflow:hidden; display:flex; flex-direction:column; color:var(--fp-light-text); background:var(--fp-light-page); --page-bg:var(--fp-light-page); --line:var(--fp-light-line); --surface:var(--fp-light-surface); --muted:var(--fp-light-muted); --accent:#3767e8; }
.shared-drive.mac { border-radius:18px; }
.shared-drive.embedded { border-radius:0; }
.shared-drive.dark { color:var(--fp-dark-text); background:var(--fp-dark-page); --page-bg:var(--fp-dark-page); --line:var(--fp-dark-line); --surface:var(--fp-dark-surface); --muted:var(--fp-dark-muted); }
...
.card{background:var(--surface);border:1px solid var(--line);border-radius:var(--fp-radius-lg)}.owner-summary{display:flex;align-items:center;gap:var(--fp-space-3);padding:var(--fp-space-3) var(--fp-space-4);margin:var(--fp-space-2) 0 var(--fp-space-3)}.summary-main{flex:1;display:flex;flex-direction:column;gap:var(--fp-space-1)}.summary-label{font-size:12px;color:var(--muted)}.summary-main strong{font-size:16px}.summary-main span,.summary-item span{font-size:12px;color:var(--muted)}.summary-item{min-width:105px;display:flex;flex-direction:column;gap:var(--fp-space-1);padding-left:var(--fp-space-3);border-left:1px solid var(--line)}.summary-item strong{font-size:15px}.toolbar{display:flex;align-items:center;gap:var(--fp-space-2);padding:var(--fp-space-2) var(--fp-space-3);margin-bottom:var(--fp-space-3)}.toolbar button,.file-toolbar button,.breadcrumbs button{border:1px solid var(--line);border-radius:var(--fp-radius-sm);background:var(--surface);color:inherit;padding:6px 10px;cursor:pointer}.toolbar button:disabled,.file-toolbar button:disabled{opacity:.45;cursor:not-allowed}.path-info{min-width:0;flex:1;display:flex;flex-direction:column;gap:var(--fp-space-1)}.path-info span{font-size:11px;color:var(--muted)}.path-info strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.remote-banner{display:flex;align-items:center;gap:var(--fp-space-3);padding:var(--fp-space-3) var(--fp-space-4);margin-bottom:var(--fp-space-3)}.remote-banner svg{color:var(--accent);width:22px;height:22px}.remote-banner div{flex:1;display:flex;flex-direction:column;gap:var(--fp-space-1)}.remote-banner span{font-size:12px;color:var(--muted)}.remote-banner button{border:1px solid var(--line);border-radius:var(--fp-radius-sm);background:var(--surface);color:inherit;padding:6px 12px;cursor:pointer}.breadcrumbs{display:flex;align-items:center;gap:5px;padding:var(--fp-space-2) var(--fp-space-3);margin-bottom:var(--fp-space-3);overflow:auto;white-space:nowrap}.breadcrumbs button{border:0;padding:4px 6px}.breadcrumbs button.active{color:var(--accent);font-weight:600}.file-panel{flex:1;min-height:0;display:flex;flex-direction:column;overflow:hidden}.file-toolbar{flex:0 0 auto;display:flex;align-items:center;gap:var(--fp-space-2);padding:var(--fp-space-2) var(--fp-space-3);border-bottom:1px solid var(--line)}.file-toolbar input{flex:1;min-width:120px;border:1px solid var(--line);background:var(--surface);color:inherit;border-radius:var(--fp-radius-sm);padding:7px 9px;outline:none}.view-note{margin-left:auto;color:var(--muted);font-size:12px}.file-list{flex:1;min-height:0;overflow:auto}.file-panel > .empty-state{flex:1;min-height:0}.file-row{display:flex;align-items:center;gap:var(--fp-space-2);min-height:var(--fp-row-height);box-sizing:border-box;padding:var(--fp-space-2) var(--fp-space-3);border-bottom:1px solid var(--line);cursor:default}.file-row:hover,.file-row.selected{background:color-mix(in srgb,var(--accent) 8%,var(--surface))}.file-icon{width:20px;height:20px;color:var(--muted);flex:0 0 20px}.file-icon.folder{color:var(--fp-warning)}.file-name{min-width:0;flex:1;display:flex;flex-direction:column;gap:var(--fp-space-1)}.file-name strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.file-name span,.file-date{font-size:12px;color:var(--muted)}.file-date{width:155px;text-align:right}.row-more{border:0;background:transparent;color:var(--muted);font-size:17px;cursor:pointer}.empty-state{min-height:300px;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:var(--fp-space-2);color:var(--muted)}.empty-state svg{width:34px;height:34px;color:var(--accent)}.empty-state strong{color:inherit}.context-menu{position:fixed;z-index:20;min-width:150px;max-width:min(260px,calc(100vw - 16px));padding:5px;border:1px solid var(--line);border-radius:var(--fp-radius-md);background:var(--surface);box-shadow:0 12px 30px rgba(0,0,0,.24)}.context-menu button{display:block;width:100%;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border:0;border-radius:var(--fp-radius-sm);background:transparent;color:inherit;text-align:left;padding:8px 10px;cursor:pointer}.context-menu button:hover{background:color-mix(in srgb,var(--accent) 12%,var(--surface))}.context-menu .danger{color:var(--fp-danger)}
