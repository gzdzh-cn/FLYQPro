...
function attachmentNeedsDecision(message: any): boolean { return !attachmentIsPaused(message) && message?.senderDeviceId !== deviceInfo.value?.deviceId && message?.attachmentStatus === 'pending' }
