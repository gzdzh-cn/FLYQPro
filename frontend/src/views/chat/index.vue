...
async function refreshPeers() { await ChatService.ScanPeers(); await new Promise((resolve) => setTimeout(resolve, 180)); store.peers = await ChatService.ListPeers(); store.network = await ChatService.NetworkStatus(); Message.success('已刷新局域网设备') }
